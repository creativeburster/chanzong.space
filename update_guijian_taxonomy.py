...
# 1. Add tuiyin person to ZEN_PERSONS (before closing ];)
# Find ZEN_PERSONS closing
persons_end = content.find('}\n];\n\nexport const ZEN_CONCEPTS')
if persons_end == -1:
...
content = content[:persons_end] + new_person + content[persons_end:]

# 2. Add new concepts to ZEN_CONCEPTS
...
new_concepts = '''  },
  {
    ...
    "etymology": "活句者，无理路可循之言句，逼拶学人至思量不及处；死句者，有理路可解之言句，学人落于知解。此说源于禅宗"参活句不参死句"之传统。",
  ...
  },
  {
    ...
    "etymology": "退隐禅师总结参话头学人易犯之十种偏差，涵盖意识分别（卜度、道理会）、身体反应（扬眉瞬目）、语言执着（语路、文字）、正面承当（举起处）、消极逃避（无事匣）、有无二边（有无会、真无会）、等待开悟（将迷待悟）等。",
    "quotes": ["离此十种病者，但举话时略抖擞精神，只疑是个甚么。 \\u2014退隐禅师"],
    "guidance": "十病总归于"以意识心参禅"。参话头之要在于疑情截断意识，而非以意识分别思量。如蚊子叮铁牛，下嘴不得处弃命一攒，方为正参。",
    "classicRef": "《禅家龟鉴》",
...
content = content[:concepts_end] + new_concepts + content[concepts_end:]

# 3. Add new method to ZEN_METHODS
...
content = content[:methods_end] + new_method + content[methods_end:]

# 4. Add 3 koans to ZEN_KOANS (koan-246 to koan-248)
...
new_koans = '''  },
  {
    ...
    "interpretation": "神会答"诸佛之本源，神会之佛性"——落于知解，以意识分别心描述本心，故被斥为孽子。怀让经八年方悟"说似一物即不中"——本心不可名状，说它像什么就不对了。嫡子与孽子之别，不在聪明，在于是否落于知解。",
    "master": "六祖惠能",
    "source": "禅家龟鉴",
...
content = content[:koans_end] + new_koans + content[koans_end:]

# 5. Add 15 FAQs to ZEN_FAQS (faq-696 to faq-710)
# Find ZEN_FAQS closing ];
...
new_faqs = '''  },
  ...
  },
  {
    id: 'faq-697',
    question: '"有一物"是什么意思？',
    answer: '退隐禅师开篇即说"有一物于此，从本以来昭昭灵灵，不曾生不曾灭，名不得状不得"。此"一物"即众生本心、佛性。六祖问"吾有一物无名无字，诸人还识否"，神会答"诸佛之本源，神会之佛性"却被斥为孽子，怀让答"说似一物即不中"被印为嫡子。差别在于：神会落于知解，怀让直下体认——本心不可名状，说它像什么就不对了。',
    relatedBooks: ['chanjia_guijian', 'tanjing'],
  },
  {
    id: 'faq-698',
    question: '禅和教有什么区别？',
    answer: '退隐禅师辨析：禅是佛心，教是佛语。世尊三处传心为禅旨，一代所说为教门。以无言至于无言者禅也，以有言至于无言者教也。失之于口则拈花微笑皆是教迹，得之于心则世间粗言细语皆是禅旨。禅教之源同为世尊，派则为迦叶（禅）与阿难（教）。教学者病在自屈（不信禅门有悟入秘诀），禅学者病在自高（不信教门有修断正路），得意修心者不自屈不自高。',
    relatedBooks: ['chanjia_guijian'],
  },
  {
    id: 'faq-699',
  ...
  },
  {
    ...
    answer: '退隐禅师兼融二者：既引五祖"守本真心胜念十方诸佛"、六祖"佛向性中作莫向身外求"，又引阿弥陀佛四十八愿劝人往生。他认为上根利智可直指本心，中下根人须借佛力。自力他力一迟一速，如种树作船（迟）与借船越海（速）。但警告"自性弥陀"者：彼佛无贪无嗔，我亦无贪嗔乎？不可以一时贡高致永劫沉堕。',
    relatedBooks: ['chanjia_guijian'],
  },
  {
    id: 'faq-706',
  ...
  },
  {
    id: 'faq-708',
    question: '"打破漆桶"是什么意思？',
    answer: '退隐禅师云：若欲敌生死，须得这一念子爆地一破，方了得生死。爆打破漆桶声——以打破漆桶然后生死可敌也。"漆桶"喻无明暗昧之心，黑漆漆一片不见光明。打破漆桶即无明顿破、亲见本来面目。诸佛因地法行者只此而已。',
    relatedBooks: ['chanjia_guijian'],
  },
  {
    id: 'faq-709',
    question: '"神光不昧万古徽猷"是什么意思？',
  ...
  },
  {
    ...
    answer: '此书适合两类人：一是初学参禅者，可借此了解参话头的正法（活句死句、三要、十病），避免走入歧途；二是兼学禅教的修行者，可借此厘清禅教关系，既不自屈（以为禅宗无悟入秘诀）也不自高（以为教门无修断正路）。全书不到万字，但涵盖禅宗修行之全体，言简意赅，最适合作为参禅入门指南。',
    relatedBooks: ['chanjia_guijian'],
  }
'''

# Find the last faq entry's closing }, before ];
# We need to insert after the last } and before \n];
# The pattern is:  },\n\n];
# Actually the last entry ends with },\n]; or similar
# Let's find the last },\n before the final ];
insert_point = faqs_end
# Go back to find the last },
last_brace = content.rfind('  },', 0, faqs_end)
if last_brace == -1:
    print("ERROR: Can't find last FAQ entry")
    exit(1)

# Insert after the last },
insert_after = last_brace + 4  # after '  },'
content = content[:insert_after] + '\n' + new_faqs + content[insert_after:]
...
print(f"tuiyin person: {verify.count('\"id\": \"tuiyin\"')}")
print(f"huoju-siju concept: {verify.count('\"id\": \"huoju-siju\"')}")
print(f"canhuoju method: {verify.count('\"id\": \"canhuoju\"')}")
print(f"koan-246: {verify.count('\"id\": \"koan-246\"')}")
print(f"koan-248: {verify.count('\"id\": \"koan-248\"')}")
faq696 = "id: 'faq-696'"
faq710 = "id: 'faq-710'"
print(f"faq-696: {verify.count(faq696)}")
print(f"faq-710: {verify.count(faq710)}")
print("Done")
