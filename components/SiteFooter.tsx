  ...
  return (
    <footer className="bg-[#0B1120] text-slate-400 border-t border-slate-800 py-8 text-xs text-center">
      <div className="flex items-center justify-center space-x-3">
        ...
        <Link href={getHref('/sitemap')} className="text-slate-400 hover:text-amber-400 transition-colors">
          {t('站点地图')}
        </Link>
        <span className="text-slate-600">|</span>
        <Link href={getHref('/about')} className="text-slate-400 hover:text-amber-400 transition-colors">
          {t('关于本站')}
        </Link>
      </div>
    </footer>
