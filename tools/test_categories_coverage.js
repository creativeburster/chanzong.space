...
const categories = [
  {
    ...
    classicIds: [
      "mazu", "baizhang", "huangbo", "linji", "dongshanyulu", "yunmen", "huanwuxinyao",
      "huanwuyulu", "dahuiyulu", "huangbo_wanlinglu", "zhaozhouyulu", "caoshanyulu",
      "fayanyulu", "yangqihoulu", "yangqiyulu", "huanglonghuinan", "shishuangchuyuan",
      "xuanshayulu", "xuanshaguanglu", "gaofengyulu", "xuefengyulu", "mianxianyulu",
      "rujingyulu", "rujingxuyulu", "weishanyulu", "qiaoyinyulu", "xutangyulu",
      "hongzhiyulu", "tianmuzhongfengguanglu", "guzunsuyulu", "zibailaorenquanji",
      "hanshanlaorenmengyouji", "fangshanwenbaoyulu", "zongmenshenan", "pingshiyulu",
      "chaozongyulu", "wenyiyulu", "yangshanyulu", "jianguanyulu", "pangjushiyulu",
      "haiyinyulu", "xisouyulu", "wujianxianduyulu", "huitangyulu", "shiwuyulu",
      "xiyanyulu", "duanqiaoyulu", "shanhuidashilu", "yuejianyulu", "huanxiyulu",
      "fenyangyulu", "shitianyulu", "mingjueyulu", "xueyanyulu", "xisouguanglu",
      "yuxuanyulu", "biyanlu", "zongjinglu"
    ],
    relatedPersons: ["mazu", "baizhang", "huangbo", "linji", "zhaozhou", "yunmen", "dongshan", "yuanwu-keqin"],
    relatedConcepts: ["mind-is-buddha", "non-mind", "direct-pointing", "koan", "mind-transmission"]
  },
  {
    id: "yinxin",
    name: "印心经藏",
    ...
    classicIds: [
      "wenshu", "jingangjing", "xinjing", "yuanjuejing", "lengyanjing", "weimojiejing",
      "lengqiejing", "shoulengyansanmeijing", "shengmanjing", "jingangsanmeijing",
      "miaofalianhuajing", "jieshenmijing", "miyanjing"
    ],
    relatedPersons: ["bodhidharma", "huineng", "xuanzang"],
    relatedConcepts: ["zhengfa-yancang", "self-nature", "buddha-nature", "emptiness", "prajna"]
  },
  {
    id: "damo",
    name: "达摩根本",
    ...
    classicIds: [
      "xuemaicong", "wuxinglun", "poxianglun", "wuxinlun", "xixulun", "sixingguan", "damoxinjinganxin"
    ],
    relatedPersons: ["bodhidharma", "huike"],
    relatedConcepts: ["beyond-words", "jianxing-chengfo", "direct-pointing", "mind-transmission", "non-mind"]
  },
  {
    id: "qinggui",
    name: "丛林清规",
    ...
    classicIds: [
      "chanyuanqinggui", "chixiu-baizhang-qinggui", "huanzhu-anqinggui", "ruzhongriyong",
      "ruzhongxuzhi", "conglinxiaodingqinggui", "chanlinbeiyongqinggui", "zimenjingxun"
    ],
    relatedPersons: ["baizhang", "daoxin", "huineng"],
    relatedConcepts: ["self-nature", "zhengfa-yancang", "dinghui-dengchi"]
  },
  {
    id: "gongan",
    name: "公案评唱",
    ...
    classicIds: [
      "wumenguan", "biyanlu", "foguojijielu", "congronglu", "xisouguanglu", "yuxuanyulu"
    ],
    relatedPersons: ["yuanwu-keqin", "xuedou-chongxian", "wumen-huikai"],
  ...
  },
  {
    ...
    classicIds: [
      "jingdechuandenglu", "wudenghuiyuan", "zhiyuelu", "chuanfazhengzongdingzutu",
      "chuanfazhengzongji", "xuchuandenglu", "lidaifabaoji"
    ],
    relatedPersons: ["qisong", "bodhidharma", "huineng", "jiashan-shanhui"],
    relatedConcepts: ["zhengfa-yancang", "chuan-deng", "mind-transmission"]
  },
  {
    id: "mingsong",
    name: "祖师铭颂",
    ...
    classicIds: [
      "qifo", "juelin", "zhengdaoge", "zhigong", "xinwangming", "shiniutu", "baojingsanmei",
      "xinxinming", "xinming", "fangcunlun"
    ],
    relatedPersons: ["sengcan", "yongjia", "niutou-farong", "dongshan"],
    relatedConcepts: ["affliction-bodhi", "self-nature", "real-mind", "non-duality"]
  },
  {
    id: "xiuxin",
    name: "禅修心要",
    ...
    classicIds: [
      "xiuxinjue", "zhenxin", "changuancejin", "chanjia_guijian", "zuochanyi",
      "boshan-canchanjingyu", "chanzongjueyiji", "anxin", "zuishangcheng", "tanjing",
      "dunwu", "shenhui", "yongjia", "jueguanlun", "sixingguan", "zhengdaoge"
    ],
    relatedPersons: ["chinul", "guifeng-zongmi", "yongjia", "bodhidharma"],
    relatedConcepts: ["dunwu-jianxiu", "dinghui-dengchi", "samadhi", "ben-lai-mian-mu"]
  },
  {
    id: "lunshi",
    name: "宗义经论",
    ...
    classicIds: [
      "bashiguijusong", "baifamingmenlun", "weishisanshilunsong", "weishiershilun",
      "chengyelun", "bianzhongbianlun", "shedachenglunben", "achengjilun", "baoxinglun",
      "dachengzhuangyanjinglun", "chengweishilun", "xianyangshengjiaolun", "dachengapidamojilun",
      "dachengqixinlun", "dachengqixinlunxinyi", "zhonglun", "shiertimenlun", "shunzhonglun",
      "baoxingwangzhenglun", "banruodenglunshi", "bailun", "putixingjing", "dachengbaoyaoyilun",
      "zongjinglu", "weixinjue", "wanshantongguiji", "zhaolun"
    ],
    relatedPersons: ["yongming-yanshou", "xuanzang", "nagarjuna", "ti-po"],
    relatedConcepts: ["zhuan-shi-cheng-zhi", "babu", "xingkong", "erdi", "shishi-wuai", "wanfa-weixin"]
  },
  {
    id: "hujiao",
    name: "护法论辩",
    ...
    classicIds: [
      "chanlinbaoxun", "linjianhoulu", "shanglibian", "shangzhibian", "zibaibieji",
      "linjianlu", "chuanfazhengzonglun", "renyantianmu", "chanyuan_zhuquanjiduxu", "zhuweimojiejing"
    ],
    relatedPersons: ["qisong", "konggu-jinglong", "hanshan-deqing"],
    relatedConcepts: ["zhengfa-yancang", "koutou-chan", "real-mind", "direct-pointing"]
  },
  {
    id: "mifa",
    name: "密乘直指",
    ...
    classicIds: [
      "wuran", "zhangzhi", "jingangge", "ziwojietuo", "songlingbaoxun", "xizangduwangjing",
      "xinxingxiuxisong", "henghedashouyin", "zixingcanjiu", "awatuotazhige", "ashitawakela"
    ],
...
// 校验
let hasError = false;
const coveredClassicIds = new Set();

for (const cat of categories) {
  for (const cid of cat.classicIds) {
    coveredClassicIds.add(cid);
    if (!manifestIds.has(cid)) {
      console.error(`[ERROR] Cat ${cat.id} has non-existent classicId: ${cid}`);
      hasError = true;
    }
  }
  for (const pid of cat.relatedPersons) {
    if (!checkRegex(personsContent, pid)) {
      console.error(`[ERROR] Cat ${cat.id} has non-existent person: ${pid}`);
      hasError = true;
    }
  }
  for (const cid of cat.relatedConcepts) {
    if (!checkRegex(conceptsContent, cid)) {
      console.error(`[ERROR] Cat ${cat.id} has non-existent concept: ${cid}`);
      hasError = true;
    }
  }
}

console.log('Total manifest classics:', manifest.length);
console.log('Covered unique classics:', coveredClassicIds.size);

const uncovered = manifest.filter(m => !coveredClassicIds.has(m.id));
if (uncovered.length > 0) {
  console.log('Uncovered classics:', uncovered.map(u => `${u.id}(${u.title})`));
} else {
  console.log('🎉 167 部经典 100% 全部被 11 大经藏分类覆盖！');
}

if (!hasError && uncovered.length === 0) {
  console.log('✅ 全部数据合法性验证通过！');
  
  // 生成 lib/categories.ts
  const tsContent = `export interface CategoryItem {
...
export const ZEN_CATEGORIES: CategoryItem[] = ${JSON.stringify(categories, null, 2)};
...
`;
  fs.writeFileSync('lib/categories.ts', tsContent, 'utf8');
  console.log('✅ 成功写入 lib/categories.ts！');
}
