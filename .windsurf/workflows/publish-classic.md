...
5. **ZEN_FAQS**：新增相关问答，编号续接现有最大编号
   ...
   - **FAQ 要尽可能覆盖每一本经典**，确保每部经典都有充足的问答
   - 问答内容涵盖：核心思想、修行方法、名相解释、现代应用、比较辨析
...
### FAQ 扩充策略
- 目标：每部经典 >= 15 条 FAQ，全站总计 660 条
- 短篇经典（心经260字、觉林偈等）6-8条翻译已充分覆盖
- 长篇经典（禅关策进31条、圜悟心要28条）翻译条目较多
- FAQ 须基于经典具体内容撰写，涵盖：核心思想、修行方法、名相解释、现代应用、比较辨析
