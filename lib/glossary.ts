...
export const ZEN_GLOSSARY: Record<string, GlossaryEntry[]> = {
  ...
  'fenyangyulu': [
    { char: '首山', pinyin: 'shǒu shān', meaning: '汝州首山第一代省念禅师，风穴延沼法嗣，临济宗第四代祖师，汾阳善昭之得法本师。' },
    { char: '西河', pinyin: 'xī hé', meaning: '古代战国及唐宋地理名词，黄河在山西、陕西两省交界流经之地。汾阳位于晋西，故善昭被尊称为“西河师子”。' },
    { char: '犀柄', pinyin: 'xī bǐng', meaning: '以犀牛角为柄之麈尾拂子。杨亿序文云“摄伽梨而登席，挥犀柄以谈空”，形容宗师升座举扬大机之法席威仪。' },
    { char: '排闼', pinyin: 'pái tà', meaning: '闼读 tà，小门。排闼即推开门扉直入其室。序文“汾阳为聪公排闼而起”，指契聪首座不辞辛劳破门迎请善昭住山之公案。' },
    { char: '顢頇', pinyin: 'mān hān', meaning: '糊涂、含混、不分青红皂白。卷下歌颂《恐顢頇》：“恐顢頇，学人未晓起心端”，诫勉学者参禅须见地分明，切忌笼统含混。' },
    { char: '毳衲', pinyin: 'cuì nà', meaning: '毳读 cuì，鸟兽细毛织成之粗陋百衲衣。卷下《因僧毳衲有颂》，喻衲僧清贫苦行、安贫乐道之高风。' },
    { char: '啮缺', pinyin: 'niè quē', meaning: '庄子寓言中向被衣问道之上古隐士。卷下《啮缺伤俊勇》，借指超迈世俗之豪迈行者亦须放下锋芒知见。' },
    { char: '翫珠', pinyin: 'wàn zhū', meaning: '翫通“玩”，赏玩摩挲。喻行者时刻观照自性摩尼宝珠、不离觉性本体。卷下作《因见古德翫珠吟乃述翫珠歌》。' },
  ],
  'shitianyulu': [
    { char: '石田', pinyin: 'shí tián', meaning: '多石硗薄之荒田。法薰禅师自号石田，比喻安于清贫、深耕祖翁所遗心田荒地之自谦与孤高。' },
    { char: '水牯牛', pinyin: 'shuǐ gǔ niú', meaning: '牯读 gǔ，公牛。禅门名喻，喻任运保任、纯熟调伏之自性本体与真如大机。' },
    { char: '拽杷', pinyin: 'zhuài pá', meaning: '拽读 zhuài，拉扯拖拽；杷读 pá，碎土平地之农具。语录序文云‘牵犁拽杷’，喻踏实纯真之农禅本色。' },
    { char: '钁头', pinyin: 'jué tóu', meaning: '古代开山掘土之大锄头。普说中‘向钁头边觅一个半个’，指在粗粝劳作中识取真实心性之法器。' },
    { char: '草䩩', pinyin: 'cǎo qiè', meaning: '䩩读 qiè，草鞋、芒鞋。语录示众常言‘踏破草䩩’，喻行脚求法、不辞辛劳之真参实修。' },
    { char: '菑畬', pinyin: 'zī shē', meaning: '菑读 zī，初垦之田；畬读 shē，耕种三年之熟田。《诗经》‘如何新畬’，喻自性修持由生转熟、功德圆满。' },
    { char: '踈狂', pinyin: 'shū kuáng', meaning: '踈同“疏”，放旷超逸、孤标傲世貌。行状形容禅师林下生涯不逐名利、超尘脱俗之高风。' },
    { char: '揑子', pinyin: 'niē zǐ', meaning: '揑同“捏”，以手拈提抓握。示总书记法语云‘这一揑子，轻如鸿毛重如泰山’，指宗门直截提撕之祖印心法。' },
  ],
  'mingjueyulu': [
    { char: '雪窦', pinyin: 'xuě dòu', meaning: '浙江奉化名山，因山有石窦、飞雪喷涌而得名。北宋重显禅师住持三十一年，海内尊称为“雪窦和尚”。' },
    { char: '光祚', pinyin: 'guāng zuò', meaning: '随州智门光祚禅师，云门文偃之法孙、香林澄远之法嗣，北宋云门宗重镇，雪窦重显之得法本师。' },
    { char: '惟盖竺', pinyin: 'wéi gài zhú', meaning: '雪窦重显门人参学小师，勤加裒辑，编订《明觉禅师语录》六卷传世。' },
    { char: '歛念', pinyin: 'liǎn niàn', meaning: '歛同“敛”，收摄万缘、息念澄虑之貌。翠峰开堂法语云“暂时歛念，直下承当”。' },
    { char: '点额', pinyin: 'diǎn é', meaning: '典出鲤鱼跳龙门，跳不过者触石碰破额头而退。万寿上堂答“选佛场开，切忌点额”，诫学者切莫随波折羽。' },
    { char: '拔榍', pinyin: 'bá xiè', meaning: '榍读 xiè，木楔子。脑后拔榍，宗门机锋名喻，指宗师以霹雳手段直截抽除学人深植心识之知见葛藤。' },
...
'xueyanyulu': [
    {
      char: '澣',
      pinyin: 'huàn',
      meaning: '古同“浣”，古代官吏十日一休假洗发，后借代为十天（一旬）。如序言“大德二年三月上澣”，即指三月上旬。'
    },
    {
      char: '橛',
      pinyin: 'jué',
      meaning: '短木桩。禅宗常用以比喻固定不可拔动、亦喻束缚之物，如“铁橛子”、“系驴橛”、“干屎橛”。'
    },
    {
      char: '庑',
      pinyin: 'wǔ',
      meaning: '堂下两旁的厢房或长廊。如卷二普说“一日我自在廊庑中东行西行”，指寺院内的回廊走道。'
    },
    {
      char: '觌',
      pinyin: 'dí',
      meaning: '相见、亲眼看见。禅门指当下现前、直面真如，如“觌面相呈”、“觌面何曾有赵州”。'
    },
    {
      char: '皤',
      pinyin: 'pó',
      meaning: '白貌、须发苍白。如卷四偈颂“皤然白发镜中见”，喻岁月推移、形骸衰朽而自性不老。'
    },
    {
      char: '拶',
      pinyin: 'zā',
      meaning: '挤压、逼迫。宗门特指师家以严厉机锋紧逼学人，令其情识无处逃遁而顿断妄念，如“悬崖一拶”、“忽然拶透赵州狗子佛性无”。'
    },
    {
      char: '麈',
      pinyin: 'zhǔ',
      meaning: '指麈尾，古代清谈及禅师说法时所执之拂子。如评论中“凡据大方握麈拂者，亦足自鉴”。'
    },
    {
      char: '肋',
      pinyin: 'lèi',
      meaning: '胸部两侧胸壁肋骨处。如普说中临济向大愚“肋下筑三拳”，宗门机锋动作。'
    }
  ],
  'miaofalianhuajing': [
    { char: '趺坐', pinyin: 'fū zuò', meaning: '趺读 fū，脚背。结跏趺坐，佛陀说法与禅坐修定之庄严坐姿，经中佛陀于灵山会上敷座结跏趺坐入无量义处三昧。' },
    { char: '栴檀', pinyin: 'zhān tán', meaning: '即旃檀，名贵芳香之木，喻清净无垢之自性功德。经云“涂香末香，栴檀沉水”，喻以戒定慧香供养诸佛。' },
    { char: '阿阇梨', pinyin: 'ā shé lí', meaning: '梵语 ācārya 之音译，意译为轨范师、教授师。能纠正弟子行仪、教授出世佛法修证之高僧大德。' },
    { char: '憍慢', pinyin: 'jiāo màn', meaning: '憍同“骄”，傲慢自大、自以为是。方便品佛说法华前，会中有五千增上慢比丘比丘尼等退席，佛听其退，名枝叶落尽纯有真实。' },
    { char: '迦陵频伽', pinyin: 'jiā líng pín qiā', meaning: '妙音鸟之梵语音译，居雪山或极乐净土，在卵壳中即能发微妙和雅之音，佛门常喻佛菩萨说法之圆润无碍梵音。' },
    { char: '揵闼婆', pinyin: 'qián tà pó', meaning: '即乾闼婆，梵语 gandharva，天龙八部众之一，帝释天之奏乐神与香阴神，以香为食，身发妙香。' },
    { char: '阿修罗', pinyin: 'ā xiū luó', meaning: '六道有情之一，意译非天、无端正。有天人之福报而嗔恨妒忌炽盛，常与诸天交战，法华会上亦归命听闻一乘妙法。' },
    { char: '罗睺罗', pinyin: 'luó hóu luó', meaning: '睺读 hóu，释迦牟尼佛出家前所生之子，佛十大弟子中“密行第一”。在法华会上蒙佛受记，当得作佛，号蹈七宝华如来。' },
    { char: '羯磨', pinyin: 'jié mó', meaning: '羯读 jié，梵语 karma 之音译，僧团依律制处理众务、受戒忏悔、议决规矩之白四羯磨法会，亦指身口意一切造作。' },
    { char: '絺綌', pinyin: 'chī xì', meaning: '絺读 chī，细葛布；綌读 xì，粗葛布。信解品形容穷子“贫穷困乏，衣褐絺綌”，喻声闻小乘自甘滞于权小知见、缺乏无漏法财。' },
  ],
  'chuanfazhengzongji': [
    { char: '镡津', pinyin: 'xán jīn', meaning: '镡读 xán，古代指剑柄与剑刃相交之剑鼻。镡津为宋代古地名（今广西藤县），契嵩大师桑梓故里，大师常署号‘镡津沙门’。' },
    { char: '毱多', pinyin: 'jū duō', meaning: '毱读 jū，踢球之皮球。西天第四祖优波毱多尊者，度人无数，每度一人以一筹投石室，筹满石室，荼毗获舍利无数。' },
    { char: '闍夜多', pinyin: 'shé yè duō', meaning: '闍读 shé，西天第二十祖闍夜多大士，智慧旷劫深广，化导难胜外道，付法于二十一祖世亲菩萨。' },
    { char: '那连耶舍', pinyin: 'nà lián yé shè', meaning: '北齐罽宾高僧、著名译经三藏，翻译《尊胜菩萨陀罗尼经》，曾传授天竺二十八祖及达摩东来之谶偈。' },
    { char: '镂板', pinyin: 'lòu bǎn', meaning: '镂读 lòu，雕镂、刻版。曹仲彝镂板记，即宋代为国家大藏经雕镂木刻印版、流布天下之刊刻功德实录。' },
    { char: '昙曜', pinyin: 'tán yào', meaning: '曜读 yào，北魏沙门统，主持开凿大同云冈石窟，撰《付法藏因缘传》，因避乱缺脱二十四祖后传记，契嵩深加考定。' },
    { char: '擯弃', pinyin: 'bìn qì', meaning: '擯同“摈”，排斥摈黜。佛陀跋陀罗在长安遭秦僧擯除，后南下庐山入慧远大师东林寺，共译华严与禅经。' },
    { char: '谶偈', pinyin: 'chèn jì', meaning: '谶读 chèn，预示未来法脉休咎之偈颂诗句。那连耶舍以六偈预言东土禅宗后世祖师代出、甘露门大开。' },
    { char: '劄子', pinyin: 'zhá zǐ', meaning: '劄同“札”，宋代朝廷高级政务官署公文与奏章。契嵩大师上宋仁宗书及中书宰执王安石、韩琦准奏之札子。' },
    { char: '袈裟', pinyin: 'jiā shā', meaning: '梵语 kāṣāya，意译坏色衣、福田衣。禅门作为释迦佛传心信物，自达摩东传至六祖惠能，止而不传以息争端。' },
  ],
  'zimenjingxun': [
    { char: '缁门', pinyin: 'zī mén', meaning: '缁读 zī，黑色。古代出家沙门皆穿坏色黑染衣，后借代指代僧众、僧团及佛教出世门庭。' },
    { char: '赜禅师', pinyin: 'zé chán shī', meaning: '赜读 zé，幽深深奥。长芦慈觉宗赜禅师，宋代云门宗尊宿，编修《禅苑清规》，撰述《坐禅仪》。' },
    { char: '羃羃', pinyin: 'mì mì', meaning: '羃读 mì，遮覆、笼罩密布貌。修雅歌“山色沈沈松烟羃羃”，形容深山林木葱郁、云雾缭绕之静修境地。' },
    { char: '挃体', pinyin: 'zhì tǐ', meaning: '挃读 zhì，以锐物刺戳或抓搔。大洪山慈忍禅师深定之中，蚊蚋啮体刺身而禅心不动、泊然无知。' },
    { char: '炊爨', pinyin: 'chuī cuàn', meaning: '爨读 cuàn，烧火造饭。慈忍禅师发大誓愿于道场中甘当苦行头陀，为大众僧执劳炊爨三年。' },
    { char: '鑱崖', pinyin: 'chán yá', meaning: '鑱读 chán，利铲铁凿。记中形容高僧开山建寺，鑱崖垒涧、平治险阻，使万仞嵯峨化为清净庄严之伽蓝。' },
    { char: '偁法主', pinyin: 'chēng fǎ zhǔ', meaning: '偁同“称”，梁代高僧智偁法师，义解精深，示寂前撰立遗诫九条训勉门人小师守节修道。' },
    { char: '莞蓆', pinyin: 'guǎn xí', meaning: '莞读 guǎn，水生蒲草。编织粗草席。梁武帝舍道事佛，宫中寝处简朴，唯用布被莞席草屨，绝去绮罗。' },
  ...
  'banruodenglunshi': [
    { char: '娵觜', pinyin: 'jū zī', meaning: '娵读 jū，觜读 zī。古代星岁纪年之十二星次之一，配二十八宿之室宿与壁宿，指农历十月或十一月。序文载波罗颇三藏于贞观元年十一月“岁次娵觜”抵长安。' },
    { char: '邠国', pinyin: 'bīn guó', meaning: '邠读 bīn，古同“豳”，古国名与封号。唐代开国功臣尚书左仆射房玄龄受封邠国公，受敕监译本论。' },
    { char: '附杙', pinyin: 'fù yì', meaning: '杙读 yì，木桩、木橛。附杙传身指三藏翻越葱岭帕米尔高原险绝栈道时，抓附岩壁木桩攀缘渡越之艰辛苦行。' },
    { char: '踈远', pinyin: 'shū yuǎn', meaning: '踈同“疏”，疏淡、相隔、不亲近。论中辨析外道僻执，与大乘诸法实相极其踈远。' },
    { char: '蠲除', pinyin: 'juān chú', meaning: '蠲读 juān，涤除、免除、彻底消灭。意谓以般若智灯照破烦恼积垢，蠲除一切妄惑苦轮。' },
    { char: '因明', pinyin: 'yīn míng', meaning: '梵语 Hetu-vidyā，古印度五明学术之一，以宗、因、喻三支论式立量驳难之佛家逻辑学，清辩菩萨于本论中广泛运用以证成空义。' },
    { char: '阿阇梨', pinyin: 'ā shé lí', meaning: '梵语 Ācārya 之音译，意译为正行轨范师、教授师。论末清辩菩萨至诚顶礼龙树阿阇梨，感念其造《中论》之恩德。' },
    { char: '嗢陀南', pinyin: 'wà tuó nán', meaning: '梵语 Udāna 之音译，意译为无问自说、总摄颂或标目颂。佛典中用以总括诸品章节要旨之概括性偈颂。' },
