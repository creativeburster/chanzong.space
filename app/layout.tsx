...
export const metadata: Metadata = {
  ...
  description: '禅宗知识库（chanzong.space）——收录64部禅宗核心典籍，含313个概念、351则公案、167位祖师、75种修持法门、2155条问答。从达摩四论、六祖坛经到无门关、碧岩录，传承顿悟见性之道。',
  ...
  openGraph: {
    ...
    description: '收录64部禅宗核心典籍，含313个概念、351则公案、167位祖师、75种法门、2155条问答。传承顿悟见性之道。',
    url: SITE_URL,
    images: [
      {
  ...
  twitter: {
    ...
    title: '禅宗知识库 | 顿悟见性之道 | ChanZong.space',
    description: '收录64部禅宗核心典籍，含313个概念、351则公案、167位祖师、75种法门。',
