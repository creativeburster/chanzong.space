...
export const metadata: Metadata = {
  ...
  description: '全量收录44部核心禅宗典籍——七佛传法偈、达摩四论、六祖坛经、黄檗传心法要、无门关、八识规矩颂、禅关策进、大乘起信论、圜悟心要、圆悟佛果禅师语录及高丽普照知讷禅师《真心直说》《修心诀》等，含163个核心概念、218则公案、102位祖师、28种修持法门、494条问答。',
  ...
  openGraph: {
    ...
    description: '全量收录44部核心禅宗典籍，含163个概念、218则公案、102位祖师、28种法门、494条问答。传承顿悟见性之道。',
    url: SITE_URL,
    images: [
      {
  ...
  twitter: {
    ...
    title: '禅宗知识库 | ChanZong.space',
    description: '全量收录44部核心禅宗典籍，含163个概念、218则公案、102位祖师、28种法门。',
