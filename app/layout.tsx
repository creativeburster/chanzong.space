...
export const metadata: Metadata = {
  ...
  description: '全量收录57部核心禅宗典籍——七佛传法偈、达摩四论、六祖坛经、黄檗传心法要、黄檗断际禅师宛陵录、赵州真际禅师语录、无门关、八识规矩颂、禅关策进、大乘起信论、圜悟心要、圆悟佛果禅师语录、心铭、坐禅仪、绝观论、博山参禅警语、曹山语录、法演语录、中论、万善同归集、禅源诸诠集都序及高丽普照知讷禅师《真心直说》《修心诀》等，含270个核心概念、295则公案、143位祖师、68种修持法门、350条问答。',
  ...
  openGraph: {
    ...
    description: '全量收录57部核心禅宗典籍，含270个概念、295则公案、143位祖师、65种法门、350条问答。传承顿悟见性之道。',
    url: SITE_URL,
    images: [
      {
