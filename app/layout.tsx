...
export const metadata: Metadata = {
  ...
  description: '禅宗知识库（chanzong.space）——收录79部禅宗核心典籍，含396个概念、559则公案、190位祖师、89种修持法门、1701条问答。从达摩四论、六祖坛经到无门关、碧岩录，传承顿悟见性之道。',
  ...
  openGraph: {
    ...
    description: '收录79部禅宗核心典籍，含396个概念、559则公案、190位祖师、89种法门、1701条问答。传承顿悟见性之道。',
    url: SITE_URL,
    images: [
      {
  ...
  twitter: {
    ...
    title: '禅宗知识库 | 顿悟见性之道 | ChanZong.space',
    description: '收录79部禅宗核心典籍，含396个概念、559则公案、190位祖师、89种法门。',
