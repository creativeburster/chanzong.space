...
export const metadata: Metadata = {
  ...
  description: '禅宗知识库（chanzong.space）——收录61部禅宗核心典籍，含291个概念、326则公案、158位祖师、70种修持法门、2010条问答。从达摩四论、六祖坛经到无门关、碧岩录，传承顿悟见性之道。',
  ...
  openGraph: {
    ...
    description: '收录61部禅宗核心典籍，含291个概念、326则公案、158位祖师、70种法门、2010条问答。传承顿悟见性之道。',
    url: SITE_URL,
    images: [
      {
  ...
  twitter: {
    ...
    title: '禅宗知识库 | 顿悟见性之道 | ChanZong.space',
    description: '收录61部禅宗核心典籍，含291个概念、326则公案、158位祖师、70种法门。',
