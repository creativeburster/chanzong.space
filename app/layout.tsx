...
export const metadata: Metadata = {
  ...
  description: '全量收录50部核心禅宗典籍——七佛传法偈、达摩四论、六祖坛经、黄檗传心法要、黄檗断际禅师宛陵录、赵州真际禅师语录、无门关、八识规矩颂、禅关策进、大乘起信论、圜悟心要、圆悟佛果禅师语录、心铭、坐禅仪及高丽普照知讷禅师《真心直说》《修心诀》等，含226个核心概念、265则公案、122位祖师、56种修持法门、780条问答。',
  ...
  openGraph: {
    ...
    description: '全量收录50部核心禅宗典籍，含226个概念、265则公案、122位祖师、56种法门、780条问答。传承顿悟见性之道。',
    url: SITE_URL,
    images: [
      {
  ...
  twitter: {
    ...
    title: '禅宗知识库 | ChanZong.space',
    description: '全量收录50部核心禅宗典籍，含226个概念、265则公案、122位祖师、56种法门。',
