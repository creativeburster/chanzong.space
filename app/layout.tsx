...
export const metadata: Metadata = {
  ...
  description: '全量收录55部核心禅宗典籍——七佛传法偈、达摩四论、六祖坛经、黄檗传心法要、黄檗断际禅师宛陵录、赵州真际禅师语录、无门关、八识规矩颂、禅关策进、大乘起信论、圜悟心要、圆悟佛果禅师语录、心铭、坐禅仪、绝观论、博山参禅警语、曹山语录、法演语录及高丽普照知讷禅师《真心直说》《修心诀》等，含248个核心概念、287则公案、123位祖师、62种修持法门、882条问答。',
  ...
  openGraph: {
    ...
    description: '全量收录55部核心禅宗典籍，含248个概念、287则公案、123位祖师、62种法门、882条问答。传承顿悟见性之道。',
    url: SITE_URL,
    images: [
      {
  ...
  twitter: {
    ...
    title: '禅宗知识库 | ChanZong.space',
    description: '全量收录55部核心禅宗典籍，含248个概念、287则公案、123位祖师、62种法门。',
